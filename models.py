...
smooth = 1.
dropout_rate = 0.5
#FIXED FROM https://stackoverflow.com/questions/35824798/tensorflow-error-using-tf-image-random-numpy-ndarray-object-has-no-attribute
...
"""
def U_Net_v1(img_rows, img_cols, color_type=1, num_class=1):
...
def U_Net_v2(pretrained_weights = None,input_size = (512,512,3)):
